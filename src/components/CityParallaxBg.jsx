...
export default function CityParallaxBg() {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden z-0 bg-[#08090D]">
      {/* Halftone Overlay */}
      <div className="absolute inset-0 comic-dots opacity-40 z-10" />

      {/* Layer 1: Night Sky & Stars */}
      <div 
        className="absolute inset-0 bg-gradient-to-b from-[#06070a] via-[#0b0e17] to-[#120914]"
      ...
      <div 
        className="absolute top-10 right-[10%] md:right-[20%] w-44 h-44 md:w-64 md:h-64 rounded-full bg-gradient-to-br from-[#EF233C] via-[#B91C2F] to-[#400810] opacity-80 filter blur-[1px] shadow-[0_0_80px_rgba(239,35,60,0.4)]"
      ...
      {/* Floating clouds */}
      <div 
        className="absolute top-20 left-0 w-full h-40 opacity-20 pointer-events-none"
      ...
      <div 
        className="absolute bottom-0 left-0 right-0 h-[45vh] opacity-40 bg-repeat-x bg-bottom flex items-end justify-around"
      ...
      <div className="absolute inset-0 pointer-events-none z-15 overflow-hidden">
        <motion.div
          ...
          className="absolute w-20 h-20 md:w-28 md:h-28 opacity-90"
        >
          ...
          <svg viewBox="0 0 120 120" className="w-full h-full filter drop-shadow-[0_0_15px_rgba(239,35,60,0.9)]">
            ...
            <g transform="translate(5, 5)">
              ...
              {/* Iconic Large White Angular Spider Eyes */}
      ...
      {/* Layer 4: Foreground Skyline Silhouette with Glowing Windows */}
      <div 
        className="absolute bottom-0 left-0 right-0 h-[35vh] md:h-[40vh] z-10"
